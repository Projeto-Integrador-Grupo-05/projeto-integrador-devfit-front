      ...
      <div className="p-8 bg-gray-100">
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          hover:shadow-2xl hover:border-2 hover:border-orange-600">
            ...
            <div className="mt-6">
              <button className="bg-orange-400 text-white px-6 py-2 rounded-lg hover:bg-orange-600">Buscar academia</button>
            </div>
            <ul className="mt-6 text-gray-600">
              <li>• Acesso ilimitado a +1.700 academias</li>
              <li>• Leve 5 amigos por mês para treinar com você</li>
          ...
          hover:shadow-2xl hover:border-2 hover:border-orange-600">
            ...
            <p className="text-gray-600 mt-2">Nosso plano mensal para você que não quer se comprometer, mas quer treinar em uma academia de alto padrão!</p>
            <div className="mt-4">
              <p className="text-gray-700">A PARTIR DE</p>
