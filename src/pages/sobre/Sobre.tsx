  ...
  const colaboradores: Colaborador[] = [
    {
      nome: "Andre",
      foto: "/Andre.png",
      cargo: "Líder de Front-End",
      bio: "Apaixonado por JavaScript, trabalho na DEVFIT desde 2018 e...",
      qrcodeData:
    ...
    <div id="forca">
      ...
      <section className="sobre">
        ...
        <p className="text-lg text-gray-700 mx-auto max-w-2xl">
          A DEVFIT nasceu com a ideia de incentivar desenvolvedores a buscar um
          ambiente confortável e saudável, longe das longas horas sentadas em
          frente aos computadores. Sabemos que a vida de um desenvolvedor
          envolve desafios constantes, como o sedentarismo, dores nas costas e o
          cansaço mental, causados pelas longas jornadas de trabalho. Por isso,
          nosso objetivo é criar um espaço que promova o bem-estar físico e
          psicológico, equilibrando as demandas do desenvolvimento de software
          com o cuidado com a saúde. Acreditamos que um corpo saudável é
          essencial para manter a mente produtiva e criativa. Nossa missão é
          incentivar hábitos saudáveis, como a prática regular de exercícios
          físicos e o descanso mental, proporcionando uma rotina que valoriza
          tanto o aprendizado técnico quanto o autocuidado. Queremos ser um
          exemplo para outras empresas, mostrando que investir no bem-estar dos
          colaboradores é essencial para um ambiente de trabalho mais
          equilibrado e eficiente. Na DEVFIT, buscamos criar uma cultura de
          saúde integrada com a tecnologia, promovendo o bem-estar e o
          ...
          <div className="border-b border-gray-300 pb-4">
            ...
            {openFAQ === 1 && (
              <div className="text-gray-700 mt-2">
                A Devfit possui unidades em várias cidades. Você pode encontrar
                todas as informações sobre nossas unidades no nosso site ou
          ...
          <div className="border-b border-gray-300 pb-4">
            ...
            {openFAQ === 2 && (
              <div className="text-gray-700 mt-2">
                ...
                benefícios. Para mais informações, consulte a seção de planos no
                nosso site.
              </div>
            )}
          </div>
      ...
      <section className="py-12 text-left">
        ...
        <p className="mb-6">
          Somos uma equipe de desenvolvedores apaixonados por criar soluções que
          promovem saúde e bem-estar. Acreditamos que um ambiente de trabalho
          saudável é fundamental para aumentar a produtividade e a satisfação,
          contribuindo para o equilíbrio físico e mental.
        </p>
